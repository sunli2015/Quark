      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li style="margin-left:10px;"><a href="#" class="addTab" data-href="error.jsp"><i class="fa fa-link"></i><span>资源管理</span></a></li>
            <li style="margin-left:10px;"><a href="#" class="addTab" data-href="error.jsp"><i class="fa fa-link"></i><span>角色管理</span></a></li>
            <li style="margin-left:10px;"><a href="#" class="addTab" data-href="error.jsp"><i class="fa fa-link"></i><span>角色管理</span></a></li>
          </ul>
        </li>
      </ul>
